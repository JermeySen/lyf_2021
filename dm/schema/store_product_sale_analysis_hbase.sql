...
(
 key                    string             comment '反转(sku编码+门店+支付日期)'
,lable_map              map<string, string> comment '业务类型_指标为动态列'
,pay_date               string             comment '支付日期'
,sku_key                string             comment 'sku编码'
)
STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler'
WITH SERDEPROPERTIES ("hbase.columns.mapping" = ":key,cf:#s:b,cf:pay_date,cf:sku_key")
